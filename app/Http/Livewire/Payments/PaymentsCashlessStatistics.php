...
class PaymentsCashlessStatistics extends Component
{
    ...
    public function getTaxLimitsProperty(): Collection
    {
        $date = new Carbon($this->periodFrom);

        return TaxLimit::query()
            ->whereBetween('month', [
...
//    public function getActualTaxLimitProperty()
//    {
//        return $tax
//    }
}
